...
public class UIRoot : CacheBehaviour
{
    public static float CurrentOrthographicSize = 1f;
    ...
    public float standardScale = 0.003125f;
    public const float UIRootEpsilon = 0.00001f;
