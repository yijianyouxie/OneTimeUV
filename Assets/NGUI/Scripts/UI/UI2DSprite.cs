...
public class UI2DSprite : UIBasicSprite
{
    ...
    {
        UI2DSprite sprite = null;
        int count = m_UI2DSpriteList.Count;
        for (int i = 0; i < count; ++i )
        {
            sprite = m_UI2DSpriteList[i];
    ...
    static List<UI2DSprite> m_UI2DSpriteList = new List<UI2DSprite>();

    protected override void Start()
    {
        m_UI2DSpriteList.Add(this);
        mStarted = true;
        OnInit();
        OnStart();
	...
	public override void OnFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols, UIGeometry uig)
	{
        //Profiler.BeginSample("UI2DSprite:OnFill");
