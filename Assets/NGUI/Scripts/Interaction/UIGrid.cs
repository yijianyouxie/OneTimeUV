...
public class UIGrid : UIWidgetContainer
{
	...
	public List<Transform> GetChildList (List<Transform> list)
	{
		...
		{
            if (sorting == Sorting.Alphabetic) list.Sort(SortByNameComp);
            else if (sorting == Sorting.Horizontal) list.Sort(SortHorizontalComp);
            else if (sorting == Sorting.Vertical) list.Sort(SortVerticalComp);
	...
	public virtual void Reposition ()
	{
        ...
        List<Transform> list = GetChildList(tlst);
#else
    ...
    private static List<Transform> tlst = new List<Transform>(128);
    
    public static List<Transform> TempTransList = tlst;

    public class SortByNameCls : IComparer<Transform>
    {
    ...
    public class SortHorizontalCls : IComparer<Transform>
    {
        public int Compare(Transform a, Transform b)
        {
    ...
    public class SortVerticalCls : IComparer<Transform>
    {
        public int Compare(Transform a, Transform b)
        {
    ...
    public static SortByNameCls SortByNameComp = new SortByNameCls();

    
    public static SortHorizontalCls SortHorizontalComp = new SortHorizontalCls();

    
    public static SortVerticalCls SortVerticalComp = new SortVerticalCls();
