...
public class UITable : UIWidgetContainer
{
	...
	public List<Transform> GetChildList (List<Transform> list)
	{
		...
		{
            if (sorting == Sorting.Alphabetic) list.Sort(UIGrid.SortByNameComp);
            else if (sorting == Sorting.Horizontal) list.Sort(UIGrid.SortHorizontalComp);
            else if (sorting == Sorting.Vertical) list.Sort(UIGrid.SortVerticalComp);
	...
	public virtual void Reposition ()
	{
        ...
        List<Transform> ch = GetChildList(UIGrid.TempTransList);
#else
