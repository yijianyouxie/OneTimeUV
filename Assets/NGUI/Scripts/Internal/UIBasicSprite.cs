...
public abstract class UIBasicSprite : UIWidget
{
	...
	[Range(0f, 1f)]
	[HideInInspector][SerializeField] public float mFillAmount = 1.0f;
...
#region Fill Functions
    ...
    private const int s_BufferSize = 200;
    static private System.Collections.Generic.Dictionary<Vector4, BetterList<Vector3>> s_vertdic = new System.Collections.Generic.Dictionary<Vector4, BetterList<Vector3>>(s_BufferSize);
    static private System.Collections.Generic.Dictionary<Color32, BetterList<Color32>> s_coldic = new System.Collections.Generic.Dictionary<Color32, BetterList<Color32>>(s_BufferSize);
    static private System.Collections.Generic.Dictionary<Vector4, int> s_vertcnt = new System.Collections.Generic.Dictionary<Vector4, int>();
    static private System.Collections.Generic.Dictionary<Color32, int> s_colcnt = new System.Collections.Generic.Dictionary<Color32, int>();
#endif
    ...
    public void RealFilledFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
