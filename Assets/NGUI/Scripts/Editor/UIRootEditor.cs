...
public class UIRootEditor : Editor
{
	public override void OnInspectorGUI ()
	{
        ...
        NGUIEditorTools.DrawProperty("UI Camera", serializedObject, "mUICamera");

        SerializedProperty cameraList = serializedObject.FindProperty("mCameraList");
        EditorGUILayout.PropertyField(cameraList, true);
